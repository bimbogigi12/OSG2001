...
if ( ! class_exists( 'CoverNews_Info' ) ) {
	...
	class CoverNews_Info {
		...
		public function configure() {
			...
			$this->menu_name     = isset( $this->config['menu_name'] ) ? $this->config['menu_name'] : sprintf( esc_html__( '%s info', 'covernews' ), $this->theme_name );
			$this->page_name     = isset( $this->config['page_name'] ) ? $this->config['page_name'] : sprintf( esc_html__( '%s info', 'covernews' ), $this->theme_name );
