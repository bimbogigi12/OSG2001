 ...
 */
class balanced_blog_Customize_Section_Pro extends WP_Customize_Section {
...
add_action( 'customize_register', 'balanced_blog_page_sections_pro' );
function balanced_blog_page_sections_pro( $manager ) {
	// Register custom section types.
	$manager->register_section_type( 'balanced_blog_Customize_Section_Pro' );

	// Register sections.
	$manager->add_section(
		new balanced_blog_Customize_Section_Pro(
			$manager,
			'balanced_blog_page_view_pro',
			array(
				'title'    => esc_html__( 'Upgrade to', 'balanced-blog' ),
				'priority' => 5, 
