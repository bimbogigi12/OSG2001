        ...
        $config = array(
            ...
            'quick_links' => array(
                'theme_url' => array(
                    ...
                    'url'  => 'https://afthemes.com/products/covernews-pro/',
                ),
                'demo_url' => array(
                    'text' => esc_html__( 'View Demo', 'covernews' ),
                    'url'  => 'https://afthemes.com/covernews-pro-a-premium-multipurpose-wordpress-news-theme/',
                ),
                'documentation_url' => array(
                    'text' => esc_html__( 'View Documentation', 'covernews' ),
                    'url'  => 'https://docs.afthemes.com/covernews-pro/',
                ),
                'rating_url' => array(
            ...
            'getting_started' => array(
                'one' => array(
                    ...
                    'button_url'  => 'https://docs.afthemes.com/covernews-pro/',
                    'button_type' => 'link',
                    'is_new_tab'  => true,
                ),
                'two' => array(
                ...
                'five' => array(
                    ...
                    'description' => sprintf( esc_html__( 'To import sample demo content, %1$s plugin should be installed and activated. After plugin is activated, visit Import Demo Data menu under Appearance.', 'covernews' ), esc_html__( 'One Click Demo Import', 'covernews' ) ),
                    'button_text' => esc_html__( 'Demo Content', 'covernews' ),
                    'button_url'  => admin_url( 'themes.php?page=covernews-pro-details&tab=demo-content' ),
                ...
                'six' => array(
                    ...
                    'button_url'  => 'https://afthemes.com/covernews-pro-a-premium-multipurpose-wordpress-news-theme/',
                    'button_type' => 'link',
                    'is_new_tab'  => true,
                ),
            ),
            ...
            //Demo content.
            'demo_content' => array(
                'description' => sprintf( esc_html__( 'To import demo content for this theme, %1$s plugin is needed. Please make sure plugin is installed and activated. After plugin is activated, you will see Import Demo Data menu under Appearance.', 'covernews' ), '<a href="https://wordpress.org/plugins/one-click-demo-import/" target="_blank">' . esc_html__( 'One Click Demo Import', 'covernews' ) . '</a>' ),
            ),
