...
if (!class_exists('CoverNews_Tabbed_Posts')) :
    ...
    class CoverNews_Tabbed_Posts extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $excerpt_length = isset($instance['covernews-excerpt-length']) ? $instance['covernews-excerpt-length'] : '20';
            $number_of_posts = isset($instance['covernews-posts-number']) ? $instance['covernews-posts-number'] : '5';
