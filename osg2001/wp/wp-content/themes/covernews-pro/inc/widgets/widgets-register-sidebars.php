...
function covernews_widgets_init()
{
    ...
    register_sidebar(array(
        'name'          => esc_html__('Frontpage Banner Ad Section', 'covernews'),
        'id'            => 'home-advertisement-widgets',
        'description'   => esc_html__('Add widgets for frontpage banner section advertisement.', 'covernews'),
        'before_widget' => '<div id="%1$s" class="widget covernews-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
    ...
    register_sidebar(array(
        'name'          => esc_html__('Single Posts Ad Section', 'covernews'),
        'id'            => 'single-posts-advertisement-widgets',
        'description'   => esc_html__('Add widgets for single posts advertisement.', 'covernews'),
        'before_widget' => '<div id="%1$s" class="widget covernews-widget %2$s">',
        'after_widget' => '</div>',
        'before_title' => '<h2 class="widget-title widget-title-1"><span>',
        'after_title' => '</span></h2>',
