...
if (!class_exists('CoverNews_Double_Col_Categorised_Posts')) :
    ...
    class CoverNews_Double_Col_Categorised_Posts extends AFthemes_Widget_Base
    {
        ...
        public function widget($args, $instance)
        {
            ...
            $layout_1 = isset($instance['covernews-select-layout-1']) ? $instance['covernews-select-layout-1'] : 'full-plus-list';
            $layout_2 = isset($instance['covernews-select-layout-2']) ? $instance['covernews-select-layout-2'] : 'list';
            $number_of_posts_1 = isset($instance['covernews-posts-number-1']) ? $instance['covernews-posts-number-1'] : 4;
            $number_of_posts_2 = isset($instance['covernews-posts-number-2']) ? $instance['covernews-posts-number-2'] : 4;
