 ...
 */
function businessly_customize_register( $wp_customize ) {
	$wp_customize->get_setting( 'blogname' )->transport         = 'postMessage';
	$wp_customize->get_setting( 'blogdescription' )->transport  = 'postMessage';
	$wp_customize->get_setting( 'header_textcolor' )->transport = 'postMessage';
	$wp_customize->get_section('header_image')->title = __( 'Header Settings', 'businessly' );
	...
	if ( isset( $wp_customize->selective_refresh ) ) {
		$wp_customize->selective_refresh->add_partial( 'blogname', array(
			...
			'render_callback' => 'businessly_customize_partial_blogname',
			) );
		$wp_customize->selective_refresh->add_partial( 'blogdescription', array(
			'selector'        => '.site-description',
			'render_callback' => 'businessly_customize_partial_blogdescription',
			) );
	}

}
add_action( 'customize_register', 'businessly_customize_register' );




if(! function_exists('businessly_customizer_css_final_output' ) ):
	function businessly_customizer_css_final_output(){
		?>
		...
		#secondary .widget{ background: <?php echo esc_attr(get_theme_mod( 'sidebar_bg_color')); ?>; }
		...
		<?php }
		add_action( 'wp_head', 'businessly_customizer_css_final_output' );
		endif;
 ...
 * @return void
 */
function businessly_customize_partial_blogname() {
	bloginfo( 'name' );
}
 ...
 * @return void
 */
function businessly_customize_partial_blogdescription() {
 ...
 */
function businessly_customize_preview_js() {
	wp_enqueue_script( 'businessly-customizer', get_template_directory_uri() . '/js/customizer.js', array( 'customize-preview' ), '20151215', true );
}
add_action( 'customize_preview_init', 'businessly_customize_preview_js' );
